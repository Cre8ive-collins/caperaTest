<template>
    <div>
        <button type="button"  @click="openModal = true"
          class="w-full mt-5 md:mt-0 md:w-auto py-2 items-center justify-center rounded-md px-8 border border-primary/40 text-primary transition-colors hover:bg-primary/10">
          New Quote
        </button>
        <AppModal :open="openModal && !isRecipientModalOpen && !isTransactionStatusModalOpen" :title="title" @close="openModal = false">
        ...
        <RecipientDetailsModal
            :open="openModal && isRecipientModalOpen && !isTransactionStatusModalOpen"
        ...
        <TransactionStatusModal
            :open="openModal && isTransactionStatusModalOpen"
